"""
Django settings for nawasons_dairy project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # include project-level templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'nawasons_dairy.wsgi.application'
...
# Use WhiteNoise storage when serving static files from Gunicorn in production
